<footer class="text-center text-white" style="background:#292d3e">
    <div class="container pt-4">
        <section class="mb-4">
            ...
            <?php } ?>
            <a class="btn btn-link btn-floating btn-lg text-dark m-1 text-decoration-none" href="mailto:<?= $info_r['info_email'] ?>" target="_blank" role="button" data-mdb-ripple-color="dark">
                <i class="fa-solid fa-envelope fs-3" style="color:red;"></i>
                <p class="d-block text-light fs-6 fw-normal"><?= $info_r['info_email'] ?></p>
            </a>
        </section>
    </div>
    <div class="text-center text-light p-3">
        © <?= date('Y') ?> Copyright:
        <a href="mailto:<?= $info_r['info_email'] ?>"><?= $info_r['info_email'] ?></a>
    </div>
</footer>