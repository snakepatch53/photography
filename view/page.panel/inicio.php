    ...
    <main>
        <div class="container">
            <div class="row g-4 py-3 p-md-4">
                <a href="<?= $proyect['url'] ?>panel/clients" class="col-md-4 text-decoration-none">
                    <div class="card shadow bg-info p-2">
                        <div class="row g-0">
                            <h5 class="text-light col-10 pt-2"><?= $client_num ?></h5>
                            <span class="text-light fs-3 col-2">
                                <i class="fa-solid fa-mug-hot"></i>
                            </span>
                        </div>
                        <p class="text-light text-center">Total de Clientes</p>
                        <img src="<?= $proyect['url'] ?>view/img/chart.png" alt="Chart Image" style="width:100%;height:50px;object-fit:cover;filter:brightness(3)">
                    </div>
                </a>
                <a href="<?= $proyect['url'] ?>panel/category" class="col-md-4 text-decoration-none">
                    <div class="card shadow bg-success p-2">
                        <div class="row g-0">
                            <h5 class="text-light col-10 pt-2"><?= $category_num ?></h5>
                            <span class="text-light fs-3 col-2">
                ...
                <a href="<?= $proyect['url'] ?>panel/albums" class="col-md-4 text-decoration-none">
                    <div class="card shadow bg-primary p-2">
                        <div class="row g-0">
                            <h5 class="text-light col-10 pt-2"><?= $album_num ?></h5>
                            <span class="text-light fs-3 col-2">
...
<foot>
    ...
    <script src="<?= $proyect['url'] ?>control/script.panel/inicio.js"></script>
</foot>
