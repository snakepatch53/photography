...
const uiFunction = {
    ...
    photoDatabase: [],
    categoryDatabase: [],
    getTralbum: function ({ album_id, album_name, client_name }) {
    ...
    refreshFrontpage: function (album_id) {
        const photos = this.photoDatabase.filter((el) => el.album_id == album_id);
        document.querySelector(`#album-item-${album_id} .frontpage`).innerHTML = this.getFrontpage(photos);
    },
